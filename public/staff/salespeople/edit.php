...
?>
<?php $page_title = 'Staff: Edit Salesperson ' . u($salesperson['first_name']) . " " . u($salesperson['last_name']); ?>
<?php include(SHARED_PATH . '/header.php'); ?>

<div id="main-content">
  <a href="index.php">Back to Salespeople List</a><br />

  <h1>Edit Salesperson: <?php echo u($salesperson['first_name']) . " " . u($salesperson['last_name']); ?></h1>
